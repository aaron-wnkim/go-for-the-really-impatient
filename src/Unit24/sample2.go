// https://pyrasis.com/book/GoForTheReallyImpatient/Unit24/02
package main
...
func SumAndDiff2(a int, b int) (sum int, diff int) { // 리턴값을 각각 sum, diff로 이름을 정함
...
func main() {
	...
	_, diff := SumAndDiff1(6, 2) // 첫 번째 리턴값은 _으로 생략, 두 번째 리턴값만 사용
